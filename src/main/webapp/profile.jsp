...
<li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="score.jsp" style="padding: 10px 20px;font-size:16px;">Score Card</a>
</li>
...
</li><br><li class="u-nav-item"><a class="u-button-style u-nav-link" href="score.jsp">Score Card</a>
...
<div class="container bootstrap snippet">
    ...
    <div class="row">
      ...
      <div class="text-center">
        <img src="images/avatar.webp" class="avatar img-circle img-thumbnail" alt="avatar">
      </div><br>
                ...
                <hr>
                      ...
                      <div class="form-group">
                        <div class="col-xs-6">
                           <h4><label for="sname">Name</label></h4>
                            <input type="text" class="form-control" name="name" id="sname" placeholder="<% out.print(name);%>" required>
                        </div>
                    </div>

                          <div class="col-xs-6">
                              <h4><label for="branch">Branch</label></h4>
                              <input type="text" class="form-control" name="branch" id="branch" placeholder="<% out.print(rs.getString("branch"));%>" required>
                          </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              ...
                              <input type="text" class="form-control" name="phone" id="phone" placeholder="<% out.print(rs.getString("phone"));%>" required>
                          </div>
                      </div>
                          ...
                          <div class="col-xs-6">
                              ...
                              <input type="email" class="form-control" name="email" id="email" placeholder="<% out.print(rs.getString("email"));%>" required>
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                            <h4><label for="password2">Verify</label></h4>
                              <input type="password" class="form-control" name="password2" id="password2" placeholder="password2" required>
                          </div>
                      </div>
                      <div class="form-group">
                           <div class="col-xs-12">
        ...
        out.print("<p>"+"Login to Continue"+"</p>");
        } 
        }
